...
twofo=1/(lambda*fnum);  % inc cutoff freq 
...
for u0=(-.7:.7/3:.7)
    for v0=(-.7:.7/3:.7)
        % wavefront 
        W=seidel_5(u0, v0, -2*lambda*fnum*Fu, -2*lambda*fnum*Fv, ...
    wd, w040, w131, w222, w220, w331);
        % coherent transfer function
        H=circ(sqrt(Fu.^2+Fv.^2)*2*lambda*fnum).*exp(-1j*k*W);
        % PSF 
